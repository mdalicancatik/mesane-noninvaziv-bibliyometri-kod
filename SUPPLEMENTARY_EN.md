...
## APPENDIX 2 — BIBLIO COMPLIANCE TABLE (20 items)
...
| Introduction | 4 | Present review of existing knowledge and epidemiological information | §1 | Met |
| Introduction | 5 | Statement of the objective(s) or question(s) | §1, final paragraphs | Met |
| Methods | 6 | Describe all information sources | §2.1 | Met |
| Methods | 7 | Keywords and systematisation criteria (date of search, language, document type) | §2.3; Appendix 1 | Met |
...
| Results | 15 | Tabulation of findings; historical view; separate reporting of review papers | §1 (historical view); §3.13 (reviews) | Met |
| Results | 16 | Synthesis of findings; identification of the gap; proposal of a model or hypothesis | §3.12, §4 | Met |
| Discussion | 17 | Summarise main findings in general, accessible terms | §4, opening paragraph | Met |
| Discussion | 18 | Interpretation consistent with results; explanation of observed patterns | §4 | Met |
...
## APPENDIX 3 — RAMIBS COMPLIANCE TABLE (12 items)
...
| 2 | Identification of prior studies, statement of how this study differs, research question and aim | §1 | Met |
| 3 | Justification of single-database choice; criteria; time frame; date of data collection; definition of indicators | §2.1, §2.2, §2.3, §2.4 | Met |
| 4 | Construction of the search string; sources of terms; appropriate use of Boolean operators and truncation | §2.3; Appendix 1 | Met |
| 5 | Date of the final search; exclusion of the current year; justification of document-type and language limits | §2.1, §2.3 | Met |
| 6 | Four indicator dimensions: production, impact, collaboration and alternative (altmetric) indicators | Production: §3.1–3.2, Figures 1–2 · Impact: §3.1, §3.3 · Collaboration: §3.5 | **Partially met** — altmetric indicators are absent from the Web of Science export and could not be assessed |
| 7 | Reporting of macro (country), meso (institution) and micro (author) levels of analysis | Macro: §3.6 · Meso: §3.6 · Micro: §3.5 | Met — gender analysis at micro level was not performed owing to the error rate of name-based assignment |
| 8 | Predefined extraction matrix; justification of analytical techniques | §2.6, §2.8 | Met |
| 9 | Name and version of all software used; visualisation parameters; term normalisation | §2.7, §2.8 | Met |
| 10 | Presentation of the full data matrix as a supplement; number of excluded records and reasons | Open archive (Zenodo); Appendix 1 | Met |
| 11 | Correspondence of results with the aim; comparison with other bibliometric studies; limitations; recommendations | §4, §4.1, §5 | Met |
| 12 | Summary of the main findings | §6 | Met |
...
## APPENDIX 4 — GLOBAL COMPLIANCE TABLE (29 items)
...
| Introduction | 2.1 | Situate the study within its context | §1 |
| Introduction | 2.2 | Rationale and knowledge gap | §1 |
| Introduction | 2.3 | Research question | §1, final paragraph |
| Introduction | 2.4 | Definition of terms, concepts and theoretical frameworks | §2.9 — the absence of a theoretical framework is stated explicitly |
| Methods | 3.1 | Bibliometric methods used | §2.2, §2.8 |
| Methods | 3.2 | Units of analysis | §2.2, §2.5 |
| Methods | 3.3 | Method of data collection | §2.3, §2.6 |
| Methods | 3.4 | Databases and data sources | §2.1 |
| Methods | 3.5 | Search strategy | §2.3; Supplementary File (full strings) |
| Methods | 3.6 | Time frame | §2.3 |
| Methods | 3.7 | Search results and selection process | §3.1; Appendix 1 |
| Methods | 3.8 | Data cleaning | §2.7 |
| Methods | 3.9 | Data analysis | §2.8 |
| Methods | 3.10 | Analytical software and versions | §2.8 |
| Methods | 3.11 | Indicators used | §2.2, §2.8 |
| Methods | 3.12 | Calculations and formulas | §2.8, "Definitions of indicators and computation rules" |
| Methods | 3.13 | Replicability and transparency | §2.8; Declarations (open code archive) |
| Results | 4.1 | Results of the study | §3 |
| Results | 4.2 | Results of the techniques used | §3.7–§3.9 |
...
| Results | 4.4 | Measures of dispersion and uncertainty | §3.1 (standard deviation, interquartile range, skewness) |
| Discussion | 5.1 | Discussion of the results | §4 |
| Discussion | 5.2 | Situating the results in the literature | §4 |
| Discussion | 5.3 | Strengths and limitations | §5 |
...
| Other | 6.3 | Use of references to support statements and methods; citation of software and datasets | References (19–21: Clauset, Hirsch, Kleinberg); §2.8 (software versions) |
